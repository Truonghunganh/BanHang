		...
		<div class="header-body">
			<div class="container beta-relative">
				...
				<div class="pull-right beta-components space-left ov">
					...
					<div class="beta-comp">
						<form role="search" method="get" id="searchform" action="seach">
							...
							<div class="beta-dropdown cart-body">
										...
										<div class="cart-item">
											<div class="media">
												...
												<div class="media-body">
													...
													<span class="cart-item-bottom"><a href="xoa-SP-trong-gio-hang/{{ $product['item']['id']}}">xóa</a> "  "<a href="xoa-nhieu_SP-trong-gio-hang/{{ $product['item']['id']}}">xóa nhiều</a></span>
												</div>
											</div>
										</div>
									@endforeach
								...
								<div class="cart-caption">
									<div class="cart-total text-right">Tổng tiền:
										<span class="cart-total-value">{{number_format(Session('cart')->totalPrice)}} đồng</span>	
									</div>
									<div class="clearfix"></div>
